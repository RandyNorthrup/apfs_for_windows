...
$requiredFiles = @(
    ...
    ".github\workflows\winfsp-runtime-build.yml",
    "CMakeLists.txt",
    "CONTRIBUTING.md",
...
$allowedTopLevel = @(
    ...
    "README.md", "RELEASE_POLICY.json", "scripts", "SECURITY.md", "src", "THIRD_PARTY_LICENSES.md",
